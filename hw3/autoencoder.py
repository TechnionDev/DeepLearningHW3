...
class EncoderCNN(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # ====== YOUR CODE: ======
        modules += [
            nn.Conv2d(in_channels = in_channels,out_channels=128,kernel_size=5,padding=3,dilation=1),
            nn.ELU(),
            nn.Dropout2d(p=0.2),
...
class DecoderCNN(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        # ====== YOUR CODE: ======
        modules += [
            nn.ConvTranspose2d(in_channels = in_channels,out_channels=512,kernel_size=5,padding=1,dilation=1,stride=2),
            nn.ELU(),
            nn.Dropout2d(p=0.2),
            nn.BatchNorm2d(num_features=512),
